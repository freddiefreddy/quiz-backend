...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/findLevelsWithCategoryID/{id}', 'HomeController@relatedLevels')->name('related.levels');

    // Levels Management
    Route::get('/levels', 'HomeController@levels')->name('levels');
    Route::get('/levels/{level}/delete', 'HomeController@destroyLevel')->name('level.delete');
    Route::post('/levels/add', 'HomeController@newLevel')->name('levels.add');
    Route::post('/questions/{question}/update', 'HomeController@updateQuestion')->name('question.update');

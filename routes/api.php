...
// Categories Api Routes
    ...
    Route::get('/levels/all', 'LevelController@all');

    Route::get('/levels/{id}/levelcategories', 'LevelController@levelCategories');

    Route::get('/categories/{id}/level', 'QuestionController@setQuestion');
...
// Questions Api Routes
    ...
    Route::get('/category/questions/level', 'QuestionController@setQuestions');

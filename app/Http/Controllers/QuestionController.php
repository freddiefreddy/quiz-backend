...
class QuestionController extends Controller
{
    ...
    public function setQuestions(Category $category){
        // $setQuestions = $category->questions->where('level', 'easy');
        $setQuestions = $category->questions->where('level_id', $id);
        return QuestionResource::collection($setQuestions);
    ...
    public function rankQuestions(Request $request)
    {
        $rankQuestions = $level->questions->where('level', $request->level)->first();
        return QuestionResource::collection($rankQuestions);
    }

                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          {{ csrf_field() }}
                          <!-- <input name="category_id" value="{{$category->id}}" class="form-control" type="hidden" id= "category_id"> -->
                          ...
                          <div class="form-group text-left">
                             <label>Choose a level</label>
                                <select name="level_id" class="custom-select" id="level">
                          </select>
                          </div>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-group text-left">
                            <label>Category</label>
                            <select name="category_id" class="custom-select" id="editcategory_id">
                            <option value="">--Select Category --</option>
                              @foreach ($categories as $category)
                                <option value = "{{$category->id}}">{{$category->name}}</option>
                              @endforeach
                          ...
                          <div class="form-group text-left">
                             <label>Choose a level</label>
                                <select name="level_id" class="custom-select" id="level_cat">
                          </select>
                          </div>
                          <div class="text-right">

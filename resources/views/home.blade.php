    ...
    <div class="col-xl-6 col-md-6 mb-4">
      <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-lg font-weight-bold text-primary text-uppercase mb-1">Levels</div>
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
                  <a href="{{ route('levels') }}" class="btn btn-primary btn-block"><i class="fas fa-edit"></i> Edit</a>
                </div>
              </div>
            </div>
            <div class="col-auto">
              <i class="fas fa-ladder fa-3x text-gray-300"></i>
            </div>
          </div>
        </div>
      </div>
